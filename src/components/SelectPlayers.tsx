  ...
  export default function SelectPlayers({ communityId, onPlayersChange }: SelectPlayersProps) {
          ...
          <View style={styles.searchResultInfo}>
            ...
            <View style={styles.searchResultMetaRow}>
              ...
              <View style={[styles.searchStatusBadge, 
                item.resident_community_id === communityId ? styles.residentSearchBadge : styles.guestSearchBadge]}>
                <MaterialCommunityIcons 
                  name={item.resident_community_id === communityId ? "home" : "account-group"} 
                  size={10} 
                  color="#fff" 
                />
                <Text style={styles.searchStatusText}>
                  {item.resident_community_id === communityId ? t('selectplayersScreen.resident') : t('selectplayersScreen.guest')}
                </Text>
              </View>
            </View>
          </View>
    ...
    ), [activeSlot, handlePlayerChange, communityId, t]);
                ...
                <View style={styles.playerDetails}>
                  ...
                  <View style={styles.playerMetaContainer}>
                    ...
                    <View style={[styles.playerTypeBadge, 
                      ...
                      <MaterialCommunityIcons 
                        name={player.resident_community_id === communityId ? "home" : "account-group"} 
                        size={10} 
                        color={player.resident_community_id === communityId ? "#4CAF50" : "#FF9800"} 
                      />
                      <Text style={[styles.playerTypeText, 
                        player.resident_community_id === communityId ? styles.residentText : styles.guestText]}>
                        {player.resident_community_id === communityId ? t('selectplayersScreen.resident') : t('selectplayersScreen.guest')}
                      </Text>
                    </View>
                  </View>
                </View>
    ...
    }, [selectedPlayers, handlePlayerChange, activeSlot, user, communityId, t]);
